...
public class YKConfig {
    ...
    public YKConfig (String user, String password, String host, String db, String port) {
        this.user = user;
    ...
    public static void main(String[] args) {
        ...
        FileManager.writeFile(new File(filePath, fileName),
                new Gson().toJson(new logic.users.example.UserConfig("u401146528_KYI04",
                        ":kWMexQ7",
                        "sql222.main-hosting.eu",
                        "u401146528_KYI04",
                        "3306"), logic.users.example.UserConfig.class));
